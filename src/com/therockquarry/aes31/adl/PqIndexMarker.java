...
public class PqIndexMarker extends BaseMarkerPoint implements Cloneable
{
	public PqIndexMarker ()
	{
		super();
	}
	
	public PqIndexMarker (String d_c_r, String d_i, String m_n, MarkerListSection p) throws InvalidDataException
	{
		_init();
	...
	public PqIndexMarker (NuendoMarkerPoint m, MarkerListSection p) throws InvalidDataException
	{
		_init();
