...
public class InfadeModifier extends BaseFadeModifier implements Cloneable {

	
	public InfadeModifier ()
	{
		super ();
		_init ();
	}
	
	public InfadeModifier (Vector v, BaseEditEntry p) throws InvalidDataException
	{
		super ();
		_init ();
	...
	public InfadeModifier (String d, String s, String ca, String cb, String cc, String st, String si, String sin) throws InvalidDataException
	{
		super ();
		_init ();
	...
	public String toString ()
	{
		...
		String rval = new String("(Infade) " + _duration + " " + _shape + " "  + (_curve_a != null ? _curve_a : "_") + " " 
	...
	{
		InfadeModifier rval = (InfadeModifier)super.clone();
