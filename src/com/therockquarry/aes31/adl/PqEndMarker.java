...
public class PqEndMarker extends BaseMarkerPoint implements Cloneable
{
	public PqEndMarker ()
	{
		super();
	...
	public PqEndMarker (String d_c_r, String d_i, String m_n, MarkerListSection p) throws InvalidDataException
	{
		_init();
	...
	public PqEndMarker (NuendoMarkerPoint m, MarkerListSection p) throws InvalidDataException
	{
		_init();
